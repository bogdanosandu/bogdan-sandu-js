...
console.warn('1. Folosind arrayul dateBuilder. Afiseaza anul curent.');
console.log(dateBuilder[0]());

console.warn('2. Afiseaza propozitia: “Suntem in luna an.”.');
console.log(`Suntem in ${dateBuilder[1]()} ${dateBuilder[0]()}.`);

console.warn('3. Afiseaza propozitia: “Astazi este zi, data.”.');
console.log(`Astazi este ${dateBuilder[3]()}, ${dateBuilder[2]()}.`);

console.warn('4. Afiseaza propozitia: “Data curenta este zi luna an.”.');
console.log(
  `Data curenta este ${dateBuilder[2]()} ${dateBuilder[1]()} ${dateBuilder[0]()}.`,
);
console.log('Astazi este Octombrie.');
